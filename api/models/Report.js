...
module.exports = {
  ...
  attributes: {
    ...
    isIn:[ 
      "ad_format_asset", "age", "body_asset", "call_to_action_asset", "country", "description_asset", "gender",
      "image_asset", "impression_device", "link_url_asset", "product_id", "region", "title_asset", "video_asset",
      "dma", "frequency_value", "hourly_stats_aggregated_by_advertiser_time_zone",
      "hourly_stats_aggregated_by_audience_time_zone", "place_page_id", "publisher_platform", 
